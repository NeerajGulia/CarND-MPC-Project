    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") 
        {
          ...
          auto coeffs = polyfit(ptsx_v, ptsy_v, Constants::POLY_ORDER);
          ...
          double px1 = v * Constants::DT;
          double py1 = 0;
          double psi1 = - v * steering * Constants::DT / Constants::LF;
          double v1 = v + throttle * Constants::DT;
          double cte1 = cte + v * sin(epsi) * Constants::DT;
          ...
          msgJson["steering_angle"] = -solution.steer_angle/deg2rad(25);
